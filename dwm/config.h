...
static const unsigned int user_bh     = 40;        /* bar height */
static const unsigned int borderpx  = 3;        /* border pixel of windows */
static const unsigned int snap      = 32;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "JetbrainsMono NF:size=16" };
static const char dmenufont[]       = "CaskaydiaCove NF:size=16";
static const char col_bg[]       = "#11111b";
static const char col_bdrnm[]       = "#313244";
static const char col_fg[]       = "#cdd6f4";
static const char col_selbg[]       = "#1e1e2e";
static const char col_accent[]        = "#89b4fa";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_bg, col_bdrnm },
...
static const char *volrel[] = {  "pkill", "-RTMIN+10", "dwmblocks", NULL };
...
static const char *const autostart[] = {
  ...
  "dwmblocks", NULL,
  "xautolock", "-time", "12", "-locker", "slock", NULL,
	NULL
};
